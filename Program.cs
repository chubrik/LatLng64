...
CheckSane(72.0, 72.0);
CheckSane((71.999999975).Dec(), 72.0);
CheckGood((71.999999975).Dec().Dec(), 71.99999995);
...
{
    CheckBase(new(latIn, lngIn), latCheck, lngCheck);
}

void CheckBase(LatLng64 latLng, double latCheck, double lngCheck)
{
    var (latOut, lngOut) = latLng.Coordinates;
